...
export class FlightPage {
  ...
  async selectAdults(count: number) {

    console.log(`${count} Adults Selected`);
  }

  async selectChildren(count: number) {

    console.log(`${count} Child Selected`);
  }

  async selectBusinessClass() {

    console.log('Business Class Selected');
  }
  ...
  async enterPassengerDetails() {
    ...
    console.log('Passenger Details Entered');
  }
